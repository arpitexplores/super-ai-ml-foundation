...
5. Rename the extracted folder from `super-ai-ml-foundation-main` to `super-ai-ml-foundation`.
6. Copy the renamed `super-ai-ml-foundation` folder into your agent's skills directory.
...
This repository is the `super-ai-ml-foundation` skill. Keep the full `super-ai-ml-foundation` folder together when installing it.
